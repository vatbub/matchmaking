...
class ConnectionWrapper(
    ...
    override fun getClientInfo(name: String?): String? = wrappedConnection.getClientInfo(name)
    ...
    override fun getWarnings(): SQLWarning? = wrappedConnection.warnings

    override fun getCatalog(): String? = wrappedConnection.catalog

    override fun setHoldability(holdability: Int) {
        wrappedConnection.holdability = holdability
    }

    override fun getSchema(): String? = wrappedConnection.schema
    ...
    override fun getTypeMap(): MutableMap<String, Class<*>> = wrappedConnection.typeMap
