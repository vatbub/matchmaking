 ...
 */
open class ResponseImpl(override val connectionId: String?, override val className: String, override var responseTo: String?) : Response {
    override fun copy() = ResponseImpl(connectionId, className, responseTo)
